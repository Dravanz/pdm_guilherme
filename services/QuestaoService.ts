  ...
  private static obterQuestoesPorIds(questaoIds: string[]): Questao[] {
    const todasQuestoes: Questao[] = [
      ...
      },
      {
        ...
        explicacao: 'const cria uma variável que não pode ser reatribuída, enquanto let permite reatribuição.',
      },
      {
        id: 'js_op_001',
      ...
      },
      {
        ...
        explicacao: 'JavaScript converte o número 3 para string e concatena, resultando em "53".',
      },
      {
        id: 'js_func_001',
      ...
      },
      {
        ...
        alternativas: [
          { id: 'a', texto: 'function soma(a, b) { return a + b; }', correta: true },
        ...
        explicacao: 'Funções em JavaScript usam "function" e "return" para retornar valores.',
      },
      {
        id: 'js_func_003',
        ...
        alternativas: [
          ...
          { id: 'b', texto: 'Sintaxe mais concisa: (a, b) => a + b', correta: true },
          { id: 'c', texto: 'Funções que não funcionam', correta: false },
          { id: 'd', texto: 'Apenas para arrays', correta: false },
        ],
        explicacao: 'Arrow functions são uma sintaxe mais concisa para escrever funções em JavaScript.',
      },
      {
        id: 'js_func_004',
        ...
        alternativas: [
          ...
          { id: 'b', texto: 'function teste(x default 10) { }', correta: false },
          { id: 'c', texto: 'function teste(x || 10) { }', correta: false },
          { id: 'd', texto: 'function teste(x: 10) { }', correta: false },
        ],
        explicacao: 'Parâmetros padrão são definidos usando = na declaração da função.',
      },
      {
        id: 'js_array_001',
      ...
      },
      {
        ...
        explicacao: 'Arrays em JavaScript começam no índice 0, então array[0] é o primeiro elemento.',
      },
      {
        id: 'js_loop_001',
        ...
        explicacao: 'O loop for (let i = 0; i < 5; i++) executa com i = 0, 1, 2, 3, 4.',
      },
      {
        id: 'js_loop_002',
        ...
        explicacao: 'O método forEach() executa uma função para cada elemento do array.',
      },
      {
        id: 'js_obj_001',
        ...
        explicacao: 'Objetos em JavaScript são criados usando chaves {} com pares chave:valor.',
      },
      {
        id: 'js_obj_002',
        ...
        explicacao: 'Propriedades podem ser acessadas com notação de ponto ou colchetes.',
      },
      {
        id: 'js_obj_003',
        ...
        alternativas: [
          ...
          { id: 'd', texto: 'obj.add("metodo", function() { })', correta: false },
        ],
      ...
      },
      {
        ...
        explicacao: 'Object.keys() retorna um array com todas as chaves do objeto.',
      },
      ...
      },
      {
        ...
        explicacao: 'Python é case-sensitive, então "Nome" e "nome" são variáveis diferentes.',
      },
      {
        id: 'py_type_001',
      ...
      },
      {
        ...
        explicacao: 'Tuplas são imutáveis (não podem ser alteradas), listas são mutáveis.',
      },
      {
        id: 'py_if_001',
        ...
        explicacao: 'Em Python, if termina com dois pontos (:) e usa indentação.',
      },
      {
        id: 'py_if_002',
      ...
      },
      {
        ...
        explicacao: 'Em Python, usamos "for item in lista:" para percorrer listas.',
      },
      {
        id: 'py_func_001',
        ...
        explicacao: 'Funções em Python são definidas com a palavra-chave "def".',
      },
      {
        id: 'py_func_002',
        ...
        explicacao: 'A palavra-chave "return" é usada para retornar valores de funções.',
      },
      {
        id: 'py_module_001',
        ...
        explicacao: 'A palavra-chave "import" é usada para importar módulos em Python.',
      },
      {
        id: 'py_module_002',
        ...
        explicacao: 'Use "from módulo import função" para importar funções específicas.',
      },
      ...
      },
      {
        ...
        explicacao: 'Use "export default" para exportar o componente principal do arquivo.',
      },
      {
        id: 'react_jsx_001',
        pergunta: 'O que é JSX?',
        alternativas: [
          { id: 'a', texto: 'Sintaxe que mistura HTML e JavaScript', correta: true },
      ...
      },
      {
        ...
        alternativas: [
          ...
          { id: 'd', texto: 'this.setState({count: novoValor})', correta: false },
        ],
        explicacao: 'Use a função setter retornada pelo useState para atualizar o state.',
      },
      {
        id: 'react_state_003',
        ...
        explicacao: 'Mudanças no state fazem o React re-renderizar o componente.',
      },
      {
        id: 'react_state_004',
      ...
      },
      {
        ...
        explicacao: 'Props são propriedades passadas de componentes pais para filhos.',
      },
      {
        id: 'react_props_002',
        pergunta: 'Como acessar props em um componente funcional?',
        alternativas: [
          { id: 'a', texto: 'function Comp(props) { return props.nome; }', correta: true },
          { id: 'b', texto: 'function Comp() { return this.props.nome; }', correta: false },
          { id: 'c', texto: 'function Comp() { return props.nome; }', correta: false },
          { id: 'd', texto: 'function Comp() { return state.nome; }', correta: false },
        ],
        explicacao: 'Props são recebidas como parâmetro da função do componente.',
      },
      {
        id: 'react_props_003',
        pergunta: 'Como usar destructuring com props?',
        alternativas: [
          { id: 'a', texto: 'function Comp({ nome, idade }) { }', correta: true },
          { id: 'b', texto: 'function Comp(nome, idade) { }', correta: false },
          { id: 'c', texto: 'function Comp([nome, idade]) { }', correta: false },
          { id: 'd', texto: 'function Comp(props.nome, props.idade) { }', correta: false },
        ],
        explicacao: 'Use destructuring {} para extrair propriedades específicas das props.',
      },
      {
        id: 'react_props_004',
        ...
        explicacao: 'Props são imutáveis - componentes filhos não podem modificá-las.',
      },
      {
        id: 'react_effect_001',
        ...
        explicacao: 'useEffect gerencia efeitos colaterais como API calls, timers, etc.',
      },
      {
        id: 'react_effect_002',
        ...
        explicacao: 'Array vazio [] como dependência faz useEffect executar apenas uma vez.',
      },
      {
        id: 'react_effect_003',
        ...
        explicacao: 'Por padrão, useEffect executa após cada renderização do componente.',
      },
      {
        id: 'react_effect_004',
        ...
        explicacao: 'Retorne uma função do useEffect para fazer cleanup quando necessário.',
      },
    ];
